...
public abstract class WorldController implements Screen {
	//DECLARE TEXTURES THAT PERSIST ACROSS ALL WORLDS HERE
	 ...
	 *
	 * Every child object created from this will have access to these assets,
	 * as long as gatherAssets.super() is called.
	 *
	 */
	public void gatherAssets() {
		// ALLOCATE TEXTURES THAT WOULD PERSIST ACROSS WORLDS
		return;
	}
